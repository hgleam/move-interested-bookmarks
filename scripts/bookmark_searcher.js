import BookmarkTreeNodeSet from './bookmark_tree_node_set';
...
export default class {
  ...
  start() {
    ...
    browser.bookmarks.get(bookmarkTreeNodeSet.parentIds, function(matchedParentTreeNodeSet) {
        ...
        let foundBookmarkTitle = new BookmarkTitle(
                                 {parent: foundParentTreeNode, current: currentBookmarkTreeNode});
        bookmarkFolders.push({id: currentBookmarkTreeNode.id, title: foundBookmarkTitle.title});
      }
    });
    return bookmarkFolders;
  }
